...
const Efacility = () => {
    ...
    useEffect(() => {
        ...
        const fetchRooms = async () => {
            try {
                setLoading(true);
                const res = await axios.get("http://127.0.0.1:8000/api/owners/"); // Use your actual API endpoint
                setRooms(res.data);
                        ...
                        {filteredRooms?.map((items) => (
                            ...
                            <div className="facility-card" key={items.organisation_id}>
                                <div className="facility-header">
                                    <img
                                        src={items.image ? `http://127.0.0.1:8000${items.image}` : "../assets/default.jpg"}
                                        alt="Facility"

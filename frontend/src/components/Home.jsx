...
const Home = () => {
    ...
    useEffect(() => {
        const silverPrice = (0.03 * 35.274 * 85.9 * 1000).toFixed(2);
        const platinumPrice = 2680;
        const ironPrice = 40;
        setPrices({ silver: silverPrice, platinum: platinumPrice, iron: ironPrice });
    }, []);
    return (
        <div>
            ...
            <div className="marquee">
                <div className="marquee-content">
                    <span>
                        💰 Latest Silver Price: <span style={{ color: "green" }}>{prices.silver}</span> per kg
                    </span>
                    <span style={{ marginLeft: "50px" }}>
                        💰 Latest Platinum Price: <span style={{ color: "green" }}>{prices.platinum}</span> per gram
                    </span>
                    <span style={{ marginLeft: "50px" }}>
                        💰 Latest Iron Price: <span style={{ color: "green" }}>{prices.iron}</span> per kg
                    </span>
                </div>
            </div>

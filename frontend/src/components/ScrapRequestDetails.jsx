...
const ScrapRequestDetails = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const res = await fetch(`http://127.0.0.1:8000/api/user-order-detail/${orderId}/`, {
                    method: "GET",
                    headers: {
    ...
    const acceptOrder = async () => {
        try {
            const res = await fetch(`http://127.0.0.1:8000/api/order-accept/${orderId}/`, {
                method: "GET",
                headers: {
                    "Content-Type": "application/json",
                    Authorization: `Bearer ${localStorage.getItem("access")}`,
    ...
    const handleRejectOrder = async () => {
        ...
        try {
            const res = await fetch(`http://127.0.0.1:8000/api/order-reject/${orderId}/`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                    Authorization: `Bearer ${localStorage.getItem("access")}`,
        ...
        <div className="container">
            <div className="left-section">
                <div className="user">
                    ...
                    <img src={"http://127.0.0.1:8000" + userData.image || '../assets/default.jpg'} alt="User" />
                </div>
                ...
                <img
                    className="scrap-img"
                    src={"http://127.0.0.1:8000" + userData.image || '../assets/default.jpg'}
                    alt="Scrap"
                ...
                <div id="myModal" className="modal">
                    ...
                    <img className="modal-content" src={"http://127.0.0.1:8000" + userData.image || '../assets/default.jpg'} alt="Scrap Zoomed" />
                </div>
